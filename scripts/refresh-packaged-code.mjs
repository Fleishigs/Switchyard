...
for(const file of ['electron/upscaler.mjs','electron/media-preview.mjs','electron/pdf-preview.mjs','electron/recall/main/main.js','electron/converter.mjs','electron/main.cjs','electron/processor.mjs','electron/extras.mjs','electron/preload.cjs','package.json']) await fs.copyFile(path.join(root,file),path.join(stage,file));
